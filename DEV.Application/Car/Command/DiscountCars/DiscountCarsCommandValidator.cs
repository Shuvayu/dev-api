...
{
    public class DiscountCarsCommandValidator : AbstractValidator<DiscountCarsCommand>
    {
        public DiscountCarsCommandValidator()
        {
            RuleForEach(x => x.CarList).SetValidator(new CarValidator());
        }
    }
